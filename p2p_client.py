            ...
            if test_flag == 1:
                ...
                for rfc_val in rfc_numbers:
                    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                        ...
                        with open('./RFC/rfc' + str(rfc_val) + '.txt', 'w+') as f:
                            while True:
...
def ask_iterative():
  ...
  print("This is the updated LIST (MERGED)\n")
  print(super_list)
